...
func TestPlanAndApply(t *testing.T) {
	cases := []struct {
		...
		{
			name:    "Cargo.toml single-quoted version",
			file:    "Cargo.toml",
			content: "[package]\nname = \"x\"\nversion = '1.5.0'\n",
			target:  Target{Path: "Cargo.toml"},
			version: "1.6.0",
		...
		{
			name:    "setup.py keyword argument",
			file:    "setup.py",
			content: "from setuptools import setup\n\nsetup(\n    name=\"x\",\n    version=\"1.5.0\",\n    packages=[],\n)\n",
			target:  Target{Path: "setup.py"},
			version: "1.6.0",
			old:     "1.5.0",
			want:    "from setuptools import setup\n\nsetup(\n    name=\"x\",\n    version=\"1.6.0\",\n    packages=[],\n)\n",
		},
		{
			name:    "Chart.yaml, not appVersion",
			file:    "Chart.yaml",
			content: "apiVersion: v2\nname: x\nversion: 1.5.0\nappVersion: \"1.16.0\"\n",
			target:  Target{Path: "Chart.yaml"},
			version: "1.6.0",
			old:     "1.5.0",
			want:    "apiVersion: v2\nname: x\nversion: 1.6.0\nappVersion: \"1.16.0\"\n",
		},
		{
			name:    "Chart.yaml quoted version",
			file:    "Chart.yaml",
			content: "apiVersion: v2\nname: x\nversion: \"1.5.0\"\n",
			target:  Target{Path: "Chart.yaml"},
			version: "1.6.0",
